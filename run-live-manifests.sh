...
manifest_guid_data.py --config /root/ndaconfig.json --collection_id 2960 2961 2962 2963 2964 2965 2966 2967 2968 --manifest_type ${manifest_type} > /tmp/nda-manifests-${manifest_type}-LIVE.csv && synapse store --parentId syn11452082 /tmp/nda-manifests-${manifest_type}-LIVE.csv;
